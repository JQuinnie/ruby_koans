...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    ## inject starts with a number and then uses that as the iterator sum or product as above
  end
  ...
  def test_all_iteration_methods_work_on_any_collection_not_just_arrays
    ...
    File.open("example_file.txt") do |file|
      upcase_lines = file.map { |line| line.strip.upcase } # strip will remove whitespace and newline
